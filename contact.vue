                        ...
                        <div class="row">
                            ...
                            <form class="form-horizontal clearfix" action="form-submit" v-on:submit.prevent="validateBeforeSubmit">
                                <div class="col-xs-12" :class="{'has-error': errors.has('name')}">
                                    ...
                                    <input v-model="form_data.name" v-validate="'required|alpha_spaces'" class="form-control" :class="{'input': true}" name="name" type="text" data-vv-delay="1000" id="name">
                                ...
                                <div class="col-xs-12" :class="{'has-error': errors.has('message')}">
                                    ...
                                    <textarea v-model="form_data.message" v-validate="'required:true'" class="form-control" :class="{'input': true}" name="message" type="text" data-vv-delay="1000" id="message"></textarea>
