<template>
    <footer>
        <section class="footer_logo">
            <div>
                <a href="http://www.cwcanadaassetservices.com/"><img alt="Bentall Kennedy Logo" class="site_logo" src="//codecloud.cdn.speedyrails.net/sites/5b22de6b6e6f640dbb2c0000/image/png/1555547664000/CW Logos-_CW_Colorlogo.png"/>    </a>
            </div>
        ...
        <section class="footer_privacy">
            <div class="main_container">
                <p class="footer_desc">&#169; {{copyright_year}} <span v-if="property">{{property.name}}</span> | Powered By <a href="//mallmaverick.com" target="_blank">Mall Maverick</a> | <a href="/pages/milton-privacy-policy">Privacy Policy</a></p>
            </div>
        </section>
    </footer>
</template>
