            ...
            <div class="row logo_container">
                <div class="col-md-2">
                    <div class="site_logo center-block">
                        <a href="/">
                            <img :alt="property.name + 'Logo'" src="//codecloud.cdn.speedyrails.net/sites/5b22de6b6e6f640dbb2c0000/image/png/1519152520000/logo.png">
                        </a>
                    </div>
                    ...
                    <div class="header_social_container hidden-sm hidden-xs">
                        <div class="header_social">
                            <div class="social_icons">
                                <span v-for="item in social_media" v-if="social_media">
                        ...
                        <div class="header_newsletter">
                            <div class="header_newsletter_container">
                                ...
                                <router-link :to="'/newsletter?email='+ newsletter_email">
                                    ...
                                    <p style="display:none;">Subscribe</p>
                                </router-link>
                            </div>
                        </div>
                    </div>
                    <transition name="custom-classes-transition" @enter="killTransition" @leave="killTransition" enter-active-class="animated slideInRight" leave-active-class="animated slideOutRight">
    ...
    define(["Vue", "vuex", "vue_router", "routes", "vue!today_hours.vue"], function (Vue, Vuex, VueRouter, appRoutes, TodayHoursComponent) {
        return Vue.component("header-component", {
            ...
            methods: {
                ...
                //this function kills the transition on the initial load
                killTransition (el, done) {
                   if(this.stopInitTrans) {
                    this.stopInitTrans = false;
                    done();
                   }
                }
            },
