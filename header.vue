        ...
        <section id="header" class="header main_container">
            <div class="row logo_container">
                ...
                <div class="col-md-10">
                    ...
                    <transition name="custom-classes-transition" @enter="killTransition" @exit="killTransition" enter-active-class="animated slideInRight" leave-active-class="animated slideOutRight">
