            ...
            <div class="row logo_container">
                <div class="col-md-2">
                    <div class="site_logo center-block">
                        <a href="/">
                            <img alt="Milton Mall Logo" src="//codecloud.cdn.speedyrails.net/sites/5a85d4e06e6f64348f070000/image/png/1519152520000/logo.png">
                        </a>
                    </div>
                    ...
                    <div class="header_social_container hidden-sm hidden-xs">
                        ...
                        <div class="header_newsletter">
                            <div class="header_newsletter_container">
                                <label for="header_newsletter" class="hidden_now">Email</label>
                                ...
                                <router-link :to="'/newsletter?email='+ newsletter_email" >
                                    <label for="header_newsletter_submit">Submit</label>
