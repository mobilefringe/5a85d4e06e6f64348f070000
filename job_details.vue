        ...
        <transition name="fade">
            <div v-if="dataLoaded" v-cloak class="main_container margin_30">
                <div v-if="currentJob" class="job_details_container">
                    <div class="row">
                        <div class="col-md-6">
                            <img v-lazy="currentJob.store.store_front_url_abs" :alt="currentJob.store.name+ ' Logo'" class="jobs_logo center-block"/>
                        </div>
                        <div class="col-md-6">
                ...
                currentJob : function (){
                    if(this.currentJob != null) {
                        if (this.currentJob.store != null && this.currentJob.store != undefined && _.includes(this.currentJob.store.store_front_url_abs, 'missing')) {
                            this.currentJob.store.store_front_url_abs = "https://placehold.it/400x400";
